...
const generateModule = async (moduleName, options) => {
    ...
    await fs_extra_1.default.writeFile(path_1.default.join(modulePath, `${kebabName}.routes.ts`), options?.crud ? (0, module_files_builder_1.buildCrudRoutesFile)(moduleName) : (0, module_files_builder_1.buildRoutesFile)(moduleName));
